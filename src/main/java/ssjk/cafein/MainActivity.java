...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class PagerAdapterClass extends PagerAdapter {
        ...
        public Object instantiateItem(View pager, int position) {
            ...
            if(position==0){
                Button mb;
                mb = (Button) findViewById(R.id.btn_toCafe);
                mb.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_button_cafe_focused, 0, 0);
                mb = (Button) findViewById(R.id.btn_toCoffee);
                mb.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_button_coffee, 0, 0);
                ...
                Button mb;
                mb = (Button) findViewById(R.id.btn_toCafe);
                mb.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_button_cafe, 0, 0);
                mb = (Button) findViewById(R.id.btn_toCoffee);
                mb.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_button_coffee_focused, 0, 0);
...
*/
  /*      LinearLayout layout = (LinearLayout) findViewById(R.id.mainscroll);
